...
import br.com.ewapps.gmailclone.model.DrawerMenuData
    ...
    Column(Modifier.verticalScroll(scrollState)) {
        ...
        menuList.forEach { 
            ...
            when{
                ...
                item.isHearder ->{
                    Text(text = item.title!!, fontWeight = FontWeight.Light, modifier = Modifier.padding(start = 20.dp, bottom = 20.dp, top = 20.dp))
                }else -> {
